...
You should always strive to read/understand any code that you execute, especially installation scripts like these.
...
- NVME only.
- EFI only.
- Encrypted /root and /swap using LVM on LUKS encryption technique.
...
```console
$ ./artix-luks-base-install /dev/nvme0nX [ENCRYPTION-PASSWORD]
```
...
1. Set default timezone to Europe/Amsterdam and sync hwclock.
1. Perform cleanups.
1. Inform user :)
